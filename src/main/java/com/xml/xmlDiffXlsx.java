...
public class xmlDiffXlsx {
    ...
    */
    public static void writeDifferences(List differences) {
        ...
        try {
            FileOutputStream outputStream = new FileOutputStream("E:\\sts_workspaces\\state_project\\filexls\\xmlDiff.xls");
    ...
    public static void main(String[] args) throws IOException, SAXException {
        ...
        File f = new File("E:\\sts_workspaces\\state_project\\filexls\\xmlDiff.xls");
        if (f.exists()){
        ...
        FileInputStream fis2 = new FileInputStream("../XmlDiffExcel/src/main/java/com/util/dest.xml");
        FileInputStream fis1 = new FileInputStream("../XmlDiffExcel/src/main/java/com/util/origin.xml");
